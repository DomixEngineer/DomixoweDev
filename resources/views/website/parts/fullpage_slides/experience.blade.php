<section class="section experience" data-anchor="experience">
    <div class="slide maxsote">
        <div class="mainContainer">
            <div class="experience-company">
                <div class="experience-company-left">
                    <div class="experience-company-left-circle">
                        <img src="{{ asset('assets/images/companies/maxsote-logo.png') }}" class="experience-company-left-circle-logo" alt="MaxSote">
                    </div>
                </div>
    ...
    <div class="slide arris">
        <div class="mainContainer">
            <div class="experience-company">
                <div class="experience-company-left">
                    <div class="experience-company-left-circle">
                        <img src="{{ asset('assets/images/companies/arris-logo.png') }}" class="experience-company-left-circle-logo" alt="ARRIS">
                    </div>
                </div>
                <div class="experience-company-right">
    ...
    <div class="slide medforum">
        <div class="mainContainer">
            <div class="experience-company">
                <div class="experience-company-left">
                    <div class="experience-company-left-circle">
                        <img src="{{ asset('assets/images/companies/medforum-logo.png') }}" class="experience-company-left-circle-logo" alt="Medforum">
                    </div>
                </div>
                <div class="experience-company-right">
    ...
    <div class="slide linkhouse">
        <div class="mainContainer">
            <div class="experience-company">
                <div class="experience-company-left">
                    <div class="experience-company-left-circle">
                        <img src="{{ asset('assets/images/companies/linkhouse-logo.png') }}" class="experience-company-left-circle-logo" alt="Linkhouse">
                    </div>
                </div>
                <div class="experience-company-right">
